...
namespace keyhanPostWeb.GeneralService
{
    public interface IApplicationUserManager
    {
        ...
        Task<List<UsersViewModel>> GetEmployeesAsync(bool isActive = true);
        Task<List<UsersViewModel>> GetAllUsersWithRolesAsync();
        Task<string> GetFullNameAsync(ApplicationUser user);
        string GetFullName(ApplicationUser user);
        ...
        Task<clsResult> UpdateUserProfileAsync(VmUpdateProfile model);
        Task<VmUpdateProfile> GetUserVmAsync(string UserName);
        Task<IdentityResult> SetLastVisitAsync(string UserName);
        Task<IdentityResult> SignUpAsync(VmSignUp usr);
        Task<IdentityResult> UserRegisterAsync(VmSignUp usr);
        UsersViewModel UserInfo(string UserName);
        UsersViewModel UserInfoById(string UserId);
